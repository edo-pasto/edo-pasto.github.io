...
if (selectedText === 'Crown height') {
  ...
  d3.csv("../../data/treesMeasures.csv", function (data) {
    ...
    // X axis: scale and draw:
    var x = d3.scaleLinear()
      .domain([0, d3.max(data, function (d) { return +d['Crown Height (m)']; })])     // can use this instead of 1000 to have the max of data: d3.max(data, function(d) { return +d.price })
      .range([0, width]);
    svgA2T1.append("g")
      .attr("transform", "translate(0," + height + ")")
      .call(d3.axisBottom(x));
    ...
    function update(nBin) {
      ...
      // set the parameters for the histogram
      var histogram = d3.histogram()
        .value(function (d) { return d['Crown Height (m)']; })   // I need to give the vector of value
        .domain(x.domain())  // then the domain of the graphic
        .thresholds(x.ticks(nBin)); // then the numbers of bins
...
if (selectedText === 'Crown width') {
  ...
  d3.csv("../../data/treesMeasures.csv", function (data) {
    ...
    // X axis: scale and draw:
    var x = d3.scaleLinear()
      .domain([0, d3.max(data, function (d) { return +d['Crown Width (m)']; })])     // can use this instead of 1000 to have the max of data: d3.max(data, function(d) { return +d.price })
      .range([0, width]);
    svgA2T1.append("g")
      .attr("transform", "translate(0," + height + ")")
      .call(d3.axisBottom(x));
    ...
    function update(nBin) {
      ...
      // set the parameters for the histogram
      var histogram = d3.histogram()
        .value(function (d) { return d['Crown Width (m)']; })   // I need to give the vector of value
        .domain(x.domain())  // then the domain of the graphic
        .thresholds(x.ticks(nBin)); // then the numbers of bins
...
if (selectedText === 'Canopy cover') {
  ...
  d3.csv("../../data/treesMeasures.csv", function (data) {
    ...
    // X axis: scale and draw:
    var x = d3.scaleLinear()
      .domain([0, d3.max(data, function (d) { return +d['Canopy Cover (m2)']; })])     // can use this instead of 1000 to have the max of data: d3.max(data, function(d) { return +d.price })
      .range([0, width]);
    svgA2T1.append("g")
      .attr("transform", "translate(0," + height + ")")
      .call(d3.axisBottom(x));
    ...
    function update(nBin) {
      ...
      // set the parameters for the histogram
      var histogram = d3.histogram()
        .value(function (d) { return d['Canopy Cover (m2)']; })   // I need to give the vector of value
        .domain(x.domain())  // then the domain of the graphic
        .thresholds(x.ticks(nBin)); // then the numbers of bins
