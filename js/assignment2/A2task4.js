...
d3.csv("../../data/top_6_treesMeasuresSmallMulti.csv", function (data) {
    ...
    const mouseoverA2T4 = function (d) {
        ...
        tooltipA2T4
            ...
            .duration(200)
        tooltipA2T4
            .html("<span style='color:grey'>Tree Height (m): </span>" + treeHeight + "<br><span style='color:grey'>CO2 Subtraction (kg/yr): </span>" + Co2Sequestration)
            .style("opacity", 1);
    ...
    d3.csv("../../data/top_6_treesMeasuresSmallMulti.csv", function (data) {
        ...
        const mouseoverA2T4 = function (d) {
            ...
            tooltipA2T4
                ...
                .style("opacity", 1)
            tooltipA2T4
                .html(`<span style='color:grey'>${selectedText_task4}: </span>` + treeMeasure + "<br><span style='color:grey'>CO2 Subtraction (kg/yr): </span>" + Co2Sequestration);
