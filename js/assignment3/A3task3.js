...
d3.queue()
    ...
    .defer(d3.csv, "../../data/neighborhoodOxygenProd.csv", function (d) {
        data.set(d.Neighborhood, +d['Oxygen Production (kg/yr)']);
    })
    .await(ready3);
...
function ready3(error, topo) {
    ...
    let mouseOver = function (d) {
        ...
        d3.select(this)
            ...
            .style("opacity", 1)
            tooltipA3T3
            .html("<span style='color:grey'>Neighborhood: </span>" + d.properties.nome + "<br>" + "<span style='color:grey'>Oxygen Production (kg/yr): </span>" + d.total)
